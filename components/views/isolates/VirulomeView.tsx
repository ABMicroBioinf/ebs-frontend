...
import { FlatVirulomeWithProfile } from "../../../models/Isolate";
import {
  JIYHeaderContext,
  JIYOrderingContext,
  JIYRecordContext,
...
function VirulomeView({
  ...
  const [records, setRecords] =
    useState<Array<JIYRecordContext<FlatVirulomeWithProfile>>>(null);
